...
{
    public MeleeWeaponDamageCollider _meleeWeaponDamageCollider;
    ...
    public void SetWeaponDamage(CharacterManager characterWeildingWeapon ,WeaponItem weapon)
    {
        ...
        _meleeWeaponDamageCollider._lightAttack_01_Modifier = weapon._lightAttack_01_Modifier;
        _meleeWeaponDamageCollider._HeavyAttack_01_Modifier = weapon._HeavyAttack_01_Modifier;
        _meleeWeaponDamageCollider._ChargeAttack_01_Modifier = weapon._ChargeAttack_01_Modifier;
    }
}
